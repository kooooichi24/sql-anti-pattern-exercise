...
---------------------------------------------------
-- comment.id = 4 を削除したい場合（サブツリー全体を削除）
...
INSERT INTO Message (parent_message_id, text) VALUES (NULL, 'このバグの原因は何かな？');
INSERT INTO Message (parent_message_id, text) VALUES (1, 'ヌルポじゃないかな？');
INSERT INTO Message (parent_message_id, text) VALUES (2, 'そうじゃないよ、それは確認済みだ。');
INSERT INTO Message (parent_message_id, text) VALUES (1, '無効な入力を調べてみたら？');
INSERT INTO Message (parent_message_id, text) VALUES (4, 'そうか、バグの原因はそれだな。');
INSERT INTO Message (parent_message_id, text) VALUES (4, 'よし、じゃあチェック機能を追加してもられるかな？');
INSERT INTO Message (parent_message_id, text) VALUES (6, '了解、修正したよ。');
